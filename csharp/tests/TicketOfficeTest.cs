...
namespace TrainKata.Tests
{
    public class TicketOfficeTest
    {
        ...
        private MakeReservationAdaptater BuildTicketOfficeService(string topologies, IBookingReferenceClient bookingReferenceClient)
        {
            return new MakeReservationAdaptater(new TrainDataClientStub(topologies), bookingReferenceClient);
        }
